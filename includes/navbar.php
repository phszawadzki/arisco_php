<nav id="navbar" class="navbar navbar-light navbar-expand-md justify-content-center" style="background-color: white;">    
    ...
    <div class="navbar-collapse collapse justify-content-between align-items-center w-100" id="collapsingNavbar2">
        <ul class="navbar-nav mx-auto text-center">
            <li class="nav-item">
                <a class="first nav-link <?php if($page=='aktualnosci'){echo 'active_red';} ?>" href="aktualnosci.php">Aktualności</a>
            </li>
            <li class="nav-item">
                <a class="second nav-link <?php if($page=='oferta'){echo 'active_green';} ?>" href="oferta.php">Oferta</a>
            </li>
            <li class="nav-item">
                <a class="second nav-link <?php if($page=='szkolenia'){echo 'active_green';} ?>" href="szkolenia.php">Szkolenia</a> 
            </li>
            <li class="nav-item pomocTechniczna_1">
                <a class="second nav-link <?php if($page=='pomocTechniczna'){echo 'active_green';} ?>" href="pomocTechniczna.php">Pomoc techniczna</a> 
            </li>
            <li class="nav-item praca_1">
                <a class="second nav-link <?php if($page=='praca'){echo 'active_green';} ?>" href="praca.php">Praca</a> 
            </li>
            <li class="nav-item oNas_1">
                <a class="second nav-link <?php if($page=='oNas'){echo 'active_green';} ?>" href="oNas.php">O nas</a> 
            </li>
            <li class="nav-item kontakt_1">
                <a class="second nav-link <?php if($page=='kontakt'){echo 'active_green';} ?>" href="kontakt.php">Kontakt</a> 
            </li>
