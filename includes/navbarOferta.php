...
<nav id="navbar2" class="navbar navbar-light navbar-expand-md justify-content-center" style="background-color: white;">    
    ...
    <div class="navbar-collapse collapse justify-content-between align-items-center w-100" id="collapsingNavbar2">
        <ul class="navbar-nav mx-auto text-center">
            <li class="nav-item">
                <a class="first nav-link <?php if($pageOferta=='wszystkie'){echo 'active_red';} ?>" href="oferta.php">Wszystkie</a>
            </li>
            <li class="nav-item">
                <a class="second nav-link <?php if($pageOferta=='administracja'){echo 'active_green';} ?>" href="ofertaAdministracja.php">Pakiet Administracja</a>
            </li>
            <li class="nav-item">
                <a class="second nav-link <?php if($pageOferta=='ochrona'){echo 'active_green';} ?>" href="ofertaOchrona.php">Pakiet Ochrona Środowiska</a> 
            </li>
            <li class="nav-item pomocTechniczna_1">
                <a class="second nav-link <?php if($pageOferta=='obieg'){echo 'active_green';} ?>" href="ofertaObieg.php">Pakiet Obieg Dokumentów</a> 
            </li>
            <li class="nav-item praca_1">
                <a class="second nav-link <?php if($pageOferta=='dedykowane'){echo 'active_green';} ?>" href="ofertaDedykowane.php">Oprogramowanie Dedykowane</a> 
            </li>
            <li class="nav-item oNas_1">
                <a class="second nav-link <?php if($pageOferta=='strony'){echo 'active_green';} ?>" href="ofertaStrony.php">Strony WWW</a> 
            </li>
