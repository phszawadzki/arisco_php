...
<div id="rowContainer" class="row pt-3 mb-5">
    ...
    $sql = "select * from tresc where t_id_dzialy='101' AND t_aktywny='T' AND  t_id_rodzica = 0 AND t_id != 449 AND p_typ = 'O' order by t_kolejnosc DESC";
