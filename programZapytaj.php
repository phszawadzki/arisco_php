    ...
    <div class="row mb-5" style="margin-top:10px">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="sekcja sticky_sekcja">
                <div class="tytul">Zadaj pytanie</div>

                
W celu zadania pytania prosimy o kontakt z Działem Sprzedaży pod numerem telefonu 42 648 03 25.
            </div>
        </div>
    </div>
    </div> 
